...
public class AlunoController {
    ...
    @GetMapping("/busca")
    public ResponseEntity<List<Aluno>> findByNomeIdade(@RequestParam("nome") String nome, @RequestParam("idade") Integer idade) {
        List<Aluno> alunos = alunoService.findByNomeIdade(nome, idade);
